...
public class App {
	...
	public static void main(String[] args) {
		...
		for (int i = 26; i > 0; i--) {
			...
			System.out.print(player1.getName() + " flipped: "); player1Card.describe();
			System.out.print(player2.getName() + " flipped: "); player2Card.describe();
			...
			System.out.println("The current score is: " + player1.score + "(" + player1.getName() + ") against " + player2.score + "(" + player2.getName()+ ") with " + draws + " draws!");
			System.out.println("Player hand size: " + player1Hand.size());
		}
		System.out.println("--------------------------------------");
		
		System.out.println(player1.getName() + "'s score is: " + player1.score);
		System.out.println(player2.getName() + "'s score is: " + player2.score);
